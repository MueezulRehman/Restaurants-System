                            ...
                            <td class="px-5 py-2.5 text-right">
                                <div class="flex items-center justify-end gap-3">
                                    <a href="{{ route('manager.medicines.edit', $m) }}"
                                       class="inline-flex h-8 w-8 items-center justify-center rounded-lg text-hut-yellow hover:bg-hut-yellow/10"
                                       aria-label="Edit medicine" title="Edit medicine"><x-icons.edit class="h-4 w-4" /></a>
                                    <form action="{{ route('manager.medicines.destroy', $m) }}" method="POST" class="inline-block">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                                                class="inline-flex h-8 w-8 items-center justify-center rounded-lg text-hut-red hover:bg-red-50"
                                                aria-label="Delete medicine" title="Delete medicine"
                                                onclick="return confirm('Delete this medicine?')"><x-icons.trash class="h-4 w-4" /></button>
                                    </form>
                                </div>
                            </td>
                        </tr>
