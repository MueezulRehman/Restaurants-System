        ...
        <table class="w-full text-sm">
            <thead class="bg-gray-50 text-gray-500 text-xs uppercase border-b">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left">Staff Type</th>
            ...
            <tbody class="divide-y divide-gray-100">
                @forelse($staff as $member)
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-4 py-3 text-gray-600">{{ $member->staff_type ? ucfirst($member->staff_type) : '-' }}</td>
                        <td class="px-4 py-3">
                            @if($member->role !== 'manager')
                ...
                @empty
                    <tr>
                        <td colspan="8" class="px-4 py-8 text-center text-gray-500">No staff members found.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
