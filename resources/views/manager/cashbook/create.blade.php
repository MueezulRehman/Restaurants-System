...
@section('page-content')
    ...
    <div class="max-w-2xl">
        <x-back-link href="{{ route('manager.cashbook.index') }}" label="Back to Cashbook" />
            ...
            <form action="{{ route('manager.cashbook.store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="description" rows="3" required
                        class="w-full border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:border-hut-green"
                        placeholder="Transaction details">{{ old('description') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="reference"
                        class="w-full border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:border-hut-green"
                        value="{{ old('reference') }}" placeholder="e.g., Invoice #123">
                </div>
