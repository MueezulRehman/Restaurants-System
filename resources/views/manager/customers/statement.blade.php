        ...
        <div class="bill">
            <div class="bill-head">
                ...
                <div style="text-align:right;">
                    ...
                    <a class="no-print sub inline-flex items-center gap-1" href="{{ route('manager.pos.receipt', ['order' => $order, 'print' => 1]) }}" target="_blank"
                        title="Open full receipt" aria-label="Open full receipt">
                        <x-icons.eye class="h-4 w-4" /> Receipt
                    </a>
                </div>
            </div>
            <table>
