            ...
            <form action="{{ route('manager.menu-items.variants.store', $item) }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="sku" required
                        ...
                        value="{{ old('sku') }}" placeholder="Unique code for this variant">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="variant_name" required
                        class="w-full border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:border-hut-green"
                        value="{{ old('variant_name') }}" placeholder="e.g. Large Pepperoni">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" min="0" name="price_override"
                        class="w-full border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:border-hut-green"
                        value="{{ old('price_override') }}" placeholder="Leave blank to use base price">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" min="0" name="cost_price"
                        class="w-full border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:border-hut-green"
                        value="{{ old('cost_price') }}" placeholder="Optional cost price">
                </div>
                ...
                <div class="flex gap-3 pt-4">
                    <button type="submit" aria-label="Create variant" title="Create variant"
