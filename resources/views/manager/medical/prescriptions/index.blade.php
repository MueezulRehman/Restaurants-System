...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('manager.prescriptions.create') }}" class="inline-flex items-center gap-2 rounded-lg bg-hut-green px-4 py-2 font-medium text-white hover:bg-hut-green/90">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-3 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="{{ route('manager.prescriptions.show', $prescription) }}" class="inline-flex items-center gap-1 text-hut-green hover:text-hut-green/80" aria-label="View prescription {{ $prescription->prescription_number }}">
