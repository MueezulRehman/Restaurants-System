...
@section('page-content')
    ...
    <div class="max-w-2xl">
        <x-back-link href="{{ route('manager.expenses.index') }}" label="Back to Expenses" />
            ...
            <form action="{{ route('manager.expenses.store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="category" required
                        ...
                        value="{{ old('category') }}" placeholder="e.g., Supplies, Rent, Utilities">
                </div>
                ...
                <div>
                    ...
                    <textarea name="description" rows="3" required
                        class="w-full border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:border-hut-green"
                        placeholder="Details about this expense">{{ old('description') }}</textarea>
                </div>
