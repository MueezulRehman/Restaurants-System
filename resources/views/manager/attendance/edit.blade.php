...
@section('page-content')
    ...
    <div class="max-w-2xl">
        <x-back-link href="{{ route('manager.attendance.index') }}" label="Back to Attendance" />
            ...
            <form action="{{ route('manager.attendance.update', $attendance) }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="notes" rows="2"
                        class="w-full border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:border-hut-green">{{ old('notes', $attendance->notes) }}</textarea>
                </div>
