            ...
            <form action="{{ route('manager.medicines.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid gap-4 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="number" name="tax" value="{{ old('tax') }}" step="0.01" min="0"
                            class="w-full rounded-lg border border-gray-200 px-3 py-2 focus:outline-none focus:border-hut-green"
                    ...
                    <div class="sm:col-span-2 rounded-xl border border-hut-yellow/40 bg-hut-yellow/10 p-4">
                        <p class="text-xs font-bold uppercase tracking-wide text-hut-dark mb-1">Quick register with barcode
                        </p>
                        <p class="text-xs text-gray-600 mb-2">Scan barcode first — name and other details fill automatically
                            when found. Set your selling price on the purchase/batch if needed.</p>
                        <label class="block text-sm font-medium text-hut-dark mb-1">Barcode</label>
                        <div class="flex flex-col gap-2 sm:flex-row">
                            <input type="text" name="barcode" id="product-barcode-input" autofocus
                                value="{{ old('barcode') }}"
                                class="w-full rounded-lg border border-gray-200 px-3 py-2.5 text-base focus:outline-none focus:border-hut-green focus:ring-2 focus:ring-hut-green/20"
                ...
                <div>
                    ...
                    <textarea name="description" rows="4"
                        class="w-full rounded-lg border border-gray-200 px-3 py-2 focus:outline-none focus:border-hut-green"
                        placeholder="Details, instructions, use cases">{{ old('description') }}</textarea>
                </div>
