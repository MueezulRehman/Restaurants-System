...
@section('content')
    ...
    <div class="max-w-2xl">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <form action="{{ route('manager.menu-items.attributes.update', [$item, $attribute]) }}" method="POST"
                class="space-y-4">
                @csrf
                @method('PATCH')
                ...
                <div>
                    ...
                    <input type="text" name="name" required
                        ...
                        value="{{ old('name', $attribute->name) }}" placeholder="e.g. Size">
                </div>

                <div class="flex gap-3 pt-4">
                    <button type="submit" aria-label="Save attribute" title="Save attribute"
