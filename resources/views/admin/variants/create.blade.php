    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <form action="{{ route('manager.menu-items.variants.store', $item) }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="number" step="0.01" min="0" name="cost_price" class="w-full border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:border-hut-green" value="{{ old('cost_price') }}" placeholder="Optional cost price">
            </div>
