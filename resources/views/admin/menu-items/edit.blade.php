    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <form action="{{ route('manager.menu-items.update', $item) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="barcode" class="w-full border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:border-hut-green" value="{{ old('barcode', $item->barcode) }}" placeholder="Scan or type the barcode (optional)">
            </div>

            <div>
                <label class="block text-sm font-medium text-hut-dark mb-1">SKU / Code</label>
                <input type="text" name="sku" class="w-full border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:border-hut-green" value="{{ old('sku', $item->sku) }}" placeholder="Optional SKU / internal code">
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="cost_price" step="0.01" min="0" class="w-full border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:border-hut-green" value="{{ old('cost_price', $item->cost_price) }}" placeholder="0">
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="unit" class="w-full border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:border-hut-green" value="{{ old('unit', $item->unit) }}" placeholder="e.g. piece, kg, bottle">
                </div>
