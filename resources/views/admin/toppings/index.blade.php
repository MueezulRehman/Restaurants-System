...
<div class="space-y-4">
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('manager.toppings.create') }}" class="inline-flex items-center rounded-lg bg-hut-dark px-4 py-2 text-sm font-semibold text-white hover:bg-gray-800">+ Add Topping</a>
    </div>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-3 text-right">
                                <div class="flex justify-end gap-3">
                                    <a href="{{ route('manager.toppings.edit', $topping) }}" class="text-hut-yellow hover:text-amber-600">Edit</a>
                                    <form action="{{ route('manager.toppings.destroy', $topping) }}" method="POST" onsubmit="return confirm('Delete this topping?')">
                                        @csrf
                                        @method('DELETE')
