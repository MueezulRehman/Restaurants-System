...
@section('content')
    <div class="mb-6 flex items-center justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-gray-500">{{ $restaurant->name }} · approve the modules each manager may open and
                delegate.</p>
        </div>
    ...
    <div class="mb-6 rounded-xl border border-blue-100 bg-blue-50 px-4 py-3 text-sm text-blue-800">
        Managers with no explicit selection inherit all modules enabled for this business. A manager may delegate only the
        modules available to their own account.
    </div>
