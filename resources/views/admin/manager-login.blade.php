...
<body class="min-h-screen flex items-center justify-center bg-[#123b35] px-4 py-10">
    <div class="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-sm border-t-4 border-[#51b9c5]">
        ...
        <form action="{{ route('manager.login.attempt') }}" method="POST" class="space-y-4">
            @csrf
            <div>
            ...
            <div>
                ...
                <div class="relative mt-1">
                    <input id="manager-password" type="password" name="password" required
                        class="w-full border border-gray-200 rounded-lg px-3 py-2 pr-16 focus:outline-none focus:border-hut-green">
                    <button type="button" data-password-toggle="manager-password"
