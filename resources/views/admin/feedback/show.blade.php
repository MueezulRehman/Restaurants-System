...
<div class="space-y-6">
    ...
    <div class="grid gap-6 lg:grid-cols-2">
        <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <form action="{{ route($feedbackPrefix . '.feedback.update-status', $feedback) }}" method="POST" class="mt-4 space-y-4">
                @csrf
                @method('PATCH')
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <form action="{{ route($feedbackPrefix . '.feedback.reply', $feedback) }}" method="POST" class="mt-4 space-y-4">
                @csrf
