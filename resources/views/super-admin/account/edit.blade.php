    ...
    <div class="max-w-4xl space-y-6">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            <div class="mb-6">
                ...
                <p class="text-sm text-gray-500">Manage your Super Admin login details.</p>
            </div>
            ...
            <form action="{{ route('admin.account.update') }}" method="POST" class="space-y-6">
                ...
                <button type="submit"
                    class="rounded-lg bg-hut-dark px-5 py-2.5 text-sm font-semibold text-white hover:bg-gray-800">
                    Save Changes
                </button>
            </form>
        </div>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            <div class="mb-6">
                ...
                <p class="text-sm text-gray-500">Use a strong password you do not use anywhere else.</p>
            </div>
            ...
            <form action="{{ route('admin.account.password') }}" method="POST" class="space-y-6">
                @csrf
                @method('PATCH')
                <div class="grid gap-6 md:grid-cols-2">
                    <div>
