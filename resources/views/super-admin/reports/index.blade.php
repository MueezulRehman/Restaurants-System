            ...
            @foreach($rows as $row)
                <tr class="border-t border-gray-100">
                    ...
                    <td class="px-4 py-3 text-right space-x-2">
                        <a href="{{ route('admin.reports.businesses.show', $row['restaurant']) }}"
                            title="View business report" aria-label="View business report"
                            class="inline-flex h-8 w-8 items-center justify-center rounded-lg text-hut-dark hover:bg-gray-100">
