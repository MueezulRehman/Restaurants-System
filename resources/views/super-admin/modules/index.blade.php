                    ...
                    @forelse($modules as $module)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 text-sm">
                                <span
                                    class="rounded-full px-2.5 py-1 text-xs font-semibold {{ $module->is_active ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-700' }}">{{ $module->is_active ? 'Active' : 'Inactive' }}</span>
                            </td>
                            <td class="px-4 py-3 text-sm">
                                <div class="flex items-center gap-3">
                                    <a href="{{ route('admin.modules.edit', $module) }}"
                                        ...
                                        aria-label="Edit module" title="Edit module">
                                    ...
                                    <form action="{{ route('admin.modules.destroy', $module) }}" method="POST"
                                        ...
                                        <button type="submit"
                                            ...
                                            aria-label="Delete module" title="Delete module">
