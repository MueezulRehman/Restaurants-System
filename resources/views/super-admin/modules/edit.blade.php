    ...
    <div class="max-w-2xl rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <form action="{{ route('admin.modules.update', $module) }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="key" value="{{ old('key', $module->key) }}" required
                    class="w-full rounded-lg border border-gray-300 px-3 py-2" />
            </div>
            ...
            <div>
                ...
                <textarea name="description" rows="4"
                    class="w-full rounded-lg border border-gray-300 px-3 py-2">{{ old('description', $module->description) }}</textarea>
            </div>
            ...
            <div class="flex items-center gap-3">
                <button type="submit"
                    ...
                    Module</button>
                <x-back-link href="{{ route('admin.modules.index') }}" label="Back to Modules" class="mb-0" />
            </div>
        </form>
    </div>
@endsection