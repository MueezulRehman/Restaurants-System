...
@section('page-content')
    ...
    <form method="post" action="{{ route('admin.restaurants.ceo-access.assign', $restaurant) }}" class="mb-6 rounded-xl border border-gray-100 bg-white p-6 shadow-sm">
        ...
        <div class="mt-4 grid gap-4 md:grid-cols-2">
            ...
            <label class="text-sm">Branch scope
                <select name="access_scope" class="mt-1 block w-full rounded-lg border border-gray-200 px-3 py-2">
                    <option value="all_branches">All branches in this business</option>
