...
class TasteHutSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Catalog records belong to the tenant database. Tenancy::runFor()
        // configures and restores the connection around the full operation.
