...
return [
    ...
    */
    'default' => [
        ...
        'expiry-tracking' => ['label' => 'Expiry Tracking', 'icon' => 'fa-calendar-days'],
        'weight-products' => ['label' => 'Weight-based Products', 'icon' => 'fa-scale-balanced'],
        'credit-sales' => ['label' => 'Credit Sales', 'icon' => 'fa-credit-card'],
        'appointments' => ['label' => 'Appointments', 'icon' => 'fa-calendar-check'],
        'memberships' => ['label' => 'Memberships', 'icon' => 'fa-id-card'],
        'service-tickets' => ['label' => 'Service Tickets', 'icon' => 'fa-screwdriver-wrench'],
        'recipes' => ['label' => 'Recipes', 'icon' => 'fa-book-open'],
        'production-batches' => ['label' => 'Production Batches', 'icon' => 'fa-industry'],
        'device-tracking' => ['label' => 'IMEI & Device Tracking', 'icon' => 'fa-mobile-screen-button'],
        'delivery-zones' => ['label' => 'Delivery Zones', 'icon' => 'fa-map-location-dot'],
        'coupons' => ['label' => 'Coupons', 'icon' => 'fa-ticket'],
        'commissions' => ['label' => 'Commissions', 'icon' => 'fa-percent'],
        'patient-records' => ['label' => 'Patient Records', 'icon' => 'fa-file-medical'],
        'follow-up-reminders' => ['label' => 'Follow-up Reminders', 'icon' => 'fa-bell'],
    ],
